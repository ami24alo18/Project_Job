...
class JobSourceRun{
    ...
    JobSourceRun(UUID sourceId,JobSourceTriggerType triggerType,Instant now){id=UUID.randomUUID();this.sourceId=sourceId;this.triggerType=triggerType;status=JobSourceRunStatus.QUEUED;createdAt=now;}
